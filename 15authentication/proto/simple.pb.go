...
var file_simple_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x22, 0x23, 0x0a,
	...
	,
...
var file_simple_proto_goTypes = []interface{}{
	(*SimpleRequest)(nil),  // 0: protobuf.auth.SimpleRequest
	(*SimpleResponse)(nil), // 1: protobuf.auth.SimpleResponse
	(*EchoRequest)(nil),    // 2: protobuf.auth.EchoRequest
	(*EchoResponse)(nil),   // 3: protobuf.auth.EchoResponse
}
var file_simple_proto_depIdxs = []int32{
	2, // 0: protobuf.auth.Simple.UnaryEcho:input_type -> protobuf.auth.EchoRequest
	0, // 1: protobuf.auth.Simple.Route:input_type -> protobuf.auth.SimpleRequest
	3, // 2: protobuf.auth.Simple.UnaryEcho:output_type -> protobuf.auth.EchoResponse
	1, // 3: protobuf.auth.Simple.Route:output_type -> protobuf.auth.SimpleResponse
...
func (c *simpleClient) UnaryEcho(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protobuf.auth.Simple/UnaryEcho", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *simpleClient) Route(ctx context.Context, in *SimpleRequest, opts ...grpc.CallOption) (*SimpleResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/protobuf.auth.Simple/Route", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Simple_UnaryEcho_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.auth.Simple/UnaryEcho",
	}
...
func _Simple_Route_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protobuf.auth.Simple/Route",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Simple_serviceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.auth.Simple",
